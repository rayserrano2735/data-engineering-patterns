...
REM ============================================================
REM Python Analytics Interview Prep v1.0.3-RC2
...
echo ===============================================
echo Python Analytics Interview Prep v1.0.3-RC2
echo ===============================================
echo.
...
set SCRIPT_DIR=%~dp0
set ZIP_FILE=%SCRIPT_DIR%paip-platform-v1.0.3-RC2.zip

if not exist "%ZIP_FILE%" (
    echo ERROR: Cannot find paip-platform-v1.0.3-RC2.zip
    echo ERROR: Cannot find paip-platform-v1.0.3-RC2.zip >> "%LOG_FILE%" 2>&1
...
if exist "%DEFAULT_VC%\.." (
    ...
    copy "%SCRIPT_DIR%UNIT_TEST_CHECKLIST.md" "%DEFAULT_VC%\" >nul 2>&1
    if errorlevel 1 (
...
echo   git commit -m "Platform v1.0.3-RC2"
echo   git tag -a v1.0.3 -m "Release v1.0.2"
echo   git push
echo.
