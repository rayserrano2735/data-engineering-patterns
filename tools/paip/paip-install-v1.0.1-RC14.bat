...
REM ============================================================
REM Python Analytics Interview Prep v1.0.1-RC14
...
echo ===============================================
echo Python Analytics Interview Prep v1.0.1-RC14
echo ===============================================
echo.
...
set SCRIPT_DIR=%~dp0
set ZIP_FILE=%SCRIPT_DIR%paip-platform-v1.0.1-RC14.zip

if not exist "%ZIP_FILE%" (
    echo ERROR: Cannot find paip-platform-v1.0.1-RC14.zip
    echo ERROR: Cannot find paip-platform-v1.0.1-RC14.zip >> "%LOG_FILE%" 2>&1
...
echo   git commit -m "Platform v1.0.1-RC14"
