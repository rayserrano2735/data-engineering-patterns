...
REM ============================================================
REM Python Analytics Interview Prep v1.0.5-RC1
...
echo ===============================================
echo Python Analytics Interview Prep v1.0.5-RC1
echo ===============================================
echo.
...
REM Log start time
echo Installing PAIP v1.0.5-RC1 > "%LOG_FILE%" 2>&1
...
set SCRIPT_DIR=%~dp0
set ZIP_FILE=%SCRIPT_DIR%paip-platform-v1.0.5-RC1.zip

if not exist "%ZIP_FILE%" (
    echo ERROR: Cannot find paip-platform-v1.0.5-RC1.zip
    echo ERROR: Cannot find paip-platform-v1.0.5-RC1.zip >> "%LOG_FILE%" 2>&1
...
if exist "%DEFAULT_VC%\.." (
    ...
    copy "%SCRIPT_DIR%UNIT_TEST_CHECKLIST-v1.0.5-RC1.md" "%DEFAULT_VC%\" >nul 2>&1
    if errorlevel 1 (
...
echo   git commit -m "Platform v1.0.5-RC1"
